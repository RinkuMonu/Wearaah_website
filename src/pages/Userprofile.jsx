...
export default function UserProfilePage() {
  ...
  console.log("UserProfilePage Render", { user });
  ...
  const onSaveAddress = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        alternateMobile: addressForm.alternateMobile
          ? String(addressForm.alternateMobile).trim()
          : "",
        ...
        coordinates:
          addressForm.lat && addressForm.lng
            ? [Number(addressForm.lng), Number(addressForm.lat)]
            : [0, 0],
  ...
  const onSetDefault = async (id) => {
    try {
      await api.patch(`/address/set-default/${id}`);
      await fetchAddresses();
  ...
  const overviewActions = [
    ...
    },
    {
      id: "overview-orders",
      label: "My Orders",
      value: user?.roleData?.totalOrders || 0,
      Icon: null,
    ...
    },
    {
      ...
      value: user?.roleData?.totalWishlist || 0,
      Icon: null,
              ...
              <>
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    Enter personal data so you do not fill it manually when
                    placing order
                  </p>
                </div>
